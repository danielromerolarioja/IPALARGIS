...
var style_Tenencia_Agua_FueradelaVivienda_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Por_En_Ter");
    var labelText = "";
    size = 0;
    ...
    if (value > 0.000000 && value <= 16.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 32.000000 && value <= 48.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 48.000000 && value <= 64.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 64.000000 && value <= 80.000000) {
            style = [ new ol.style.Style({
