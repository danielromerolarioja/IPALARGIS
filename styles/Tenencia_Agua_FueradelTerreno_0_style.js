...
var style_Tenencia_Agua_FueradelTerreno_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Por_Fue_Te");
    var labelText = "";
    size = 0;
    ...
    if (value > 0.000000 && value <= 12.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 36.000000 && value <= 48.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 48.000000 && value <= 60.000000) {
            style = [ new ol.style.Style({
